...
function LuaExportAfterNextFrame()
	...
	socket.try(c:send(string.format("Time=%.3f, name=%s, V_ind=%.3f, Norml=%.3f, Axial=%.3f, Side=%.3f, Q=%.3f, P=%.3f, R=%.3f, Pitch=%.3f, Roll=%.3f, Hding=%.3f, Lat=%.7f, Lon=%.7f, Alt=%.3f, RAlt=%.3f, Pos_E=%.3f, Pos_U=%.3f, Pos_S=%.3f, Vel_E=%.3f, Vel_U=%.3f, Vel_S=%.3f, Elev=%.3f, Ailr=%.3f, Rudd=%.3f\n", t, name, IndicatedAirSpeed, AccelerationUnits.y, AccelerationUnits.x*-1, AccelerationUnits.z*-1, AngularVelocity.z, AngularVelocity.x, AngularVelocity.y*-1, o.Pitch*57.2958, o.Bank*57.2958, o.Heading*57.2958, o.LatLongAlt.Lat, o.LatLongAlt.Long, AltitudeAboveSeaLevel, AltitudeAboveGroundLevel,o.Position.z, o.Position.y, o.Position.x*-1,VectorVelocity.z, VectorVelocity.y, VectorVelocity.x*-1, Elev, Ailr, Rudd)))
